...
if(isset($_GET['excluir'])) {
    ...
    $res = mysqli_query($conexao, "SELECT imagem_url FROM trabalho_terceiro WHERE id = $id");
    ...
    mysqli_query($conexao, "DELETE FROM trabalho_terceiro WHERE id = $id") or die("Erro ao excluir: " . mysqli_error($conexao));
...
if(isset($_POST['editar'])) {
    ...
    $update_sql = "UPDATE trabalho_terceiro SET nome='$nome', descricao='$descricao', preco=$preco WHERE id=$id";
...
$trabalho_terceiro = mysqli_query($conexao, "SELECT * FROM trabalho_terceiro ORDER BY id DESC");
...
<div id="main">
    <div id="geral">
        ...
        <div class="trabalho_terceiro">
            <?php while($res = mysqli_fetch_assoc($trabalho_terceiro)): ?>
                <div class="produto">
